...
module.exports = function (options, callback) {
    ...
    function drawSummaryChart(summary) {
        return [
            ...
            [blankCell(), 'DISCOUNT', { alignment: 'right', text: data.discount }],
            [blankCell(), 'VAT', { alignment: 'right', text: data.vat }],
            [blankCell(), 'GRAND TOTAL', { alignment: 'right', text: numberWithComma(data.grandTotal) }]
